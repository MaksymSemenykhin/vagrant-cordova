...
sudo cp /image/config/androidtool-local.cfg  ~/.android/androidtool.cfg
...
echo "export JAVA_HOME=/opt/jdk/jdk1.8.0_171/jre" >> /etc/bash.bashrc
echo "export JRE_HOME=/opt/jdk/jdk1.8.0_171/jre" >> /etc/bash.bashrc
